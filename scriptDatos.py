...
archivo_excel = "c:/Users/SISTEMAS/Downloads/Gabriel servicio ligero.xlsx"
...
columnas_deseadas = ['A','B','C','D','E','F','G','H','I','J','K','L','M','N','O','P','Q','R','S']
...
for fila in datos_excel:
    ...
    insertar_query = f"INSERT INTO servicioligero (MarcaAuto, Submarca, Referencia, Modelo, AnoInicio, AnoFinal, Marca, Posicion, Tipo, LongExp, LongComp, Carrera, MontSup, MontInf, MONROE, GRC, KYB, BOGE, info) VALUES (%s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
